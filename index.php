...
<html lang="pt-br">
    <head>
        ...
        <meta name="description" content="Projeto com JS">
    ...
    <body class="no-js">
        ...
        <header class="header">
            <a href="index.html" class="logo-txt">Infusion</a>
        ...
        <div class="container">
            <section class="people-cards">
                <article class="people-cards__card">               
                    <img src="img/c01.jpg" alt="Carousel Img" class="people-cards__imagem">
                ...
                <article class="people-cards__card">               
                    <img src="img/c02.jpg" alt="Carousel Img" class="people-cards__imagem">
                    <div class="people-cards__avatar">
                ...
                <article class="people-cards__card">               
                    <img src="img/c03.jpg" alt="Carousel Img" class="people-cards__imagem">
                    <div class="people-cards__avatar">
                ...
                <article class="people-cards__card">               
                    <img src="img/c04.jpg" alt="Carousel Img" class="people-cards__imagem">
                    <div class="people-cards__avatar">
